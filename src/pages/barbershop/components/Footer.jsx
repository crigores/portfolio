export default function Footer() {
	return (
		<div className="flex flex-col w-full h-fit bg-[#181C14] text-[#e5e7eb] px-14 py-14">
			<div className="flex flex-row">
				<div className="flex flex-col gap-2 justify-center w-[35%]">
					<div className="flex items-center w-full gap-4">
						<img src="https://tailwind-generator.b-cdn.net/favicon.png" width="120" alt="Logo Preview" />
						<div className="text-5xl font-bold ">Samuel Barbershop</div>
					</div>
			...
			<div className="text-center">© 2024 Samuel Barbershop - All rights reserved.</div>
		</div>
	)
}
